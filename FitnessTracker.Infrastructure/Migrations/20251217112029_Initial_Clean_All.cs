...
{
    /// <inheritdoc />
    public partial class Initial_Clean_All : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WarningLogs_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WarningLogs_TrainingSessions_TrainingSessionId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), "role-admin", "Admin", "ADMIN" },
                    { new Guid("22222222-2222-2222-2222-222222222222"), "role-manager", "Manager", "MANAGER" },
                    { new Guid("33333333-3333-3333-3333-333333333333"), "role-user", "User", "USER" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), 0, "92e4d0be-777b-45a9-9784-da625329ac0d", "admin@local.test", true, false, null, "ADMIN@LOCAL.TEST", "ADMIN", "AQAAAAIAAYagAAAAEIZV4qSnv5tF21/FZm25xySEpIha2rvwDfh6DqAyrMoOrebB+Jtzx7wfE8b+z+Vy9A==", null, false, "545863cb-f9da-4d15-8865-b1706572e298", false, "admin" },
                    { new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), 0, "3426ba95-48be-4e50-8b97-5cd8c74f0003", "manager@local.test", true, false, null, "MANAGER@LOCAL.TEST", "MANAGER", "AQAAAAIAAYagAAAAEOrxcLxFc4Prt+6gh+RkolJGf2OMkuy69S6t0qVrXbXphSmQn57KSgFDTMbdng5nXQ==", null, false, "5c4ee39b-95ae-4645-874b-470e09291cc6", false, "manager" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WarningLogs_TrainingSessionId",
                table: "WarningLogs",
                column: "TrainingSessionId");

            migrationBuilder.CreateIndex(
                name: "IX_WarningLogs_UserId",
                table: "WarningLogs",
                column: "UserId");
        }
